...
sealed interface ChatIntent : MviIntent {
    ...
    data class OnSpeechResult(val text: String) : ChatIntent
...
internal val fakeMessages = listOf(
    ChatMessage("1", "Hello! I'm Neurix. How can I help you today?", false, "10:30 AM"),
